...
<div class="container pt-5">
    ...
    <!-- 첫 페이지 -->
       ...
       <c:forEach var="i" begin="${pageInfo.navigateFirstPage }" 
             ...
             <li><a href="?bid=${param.bid }&page=${i}" 
       ...
       <c:choose>
	       	<c:when test="${pageInfo.hasNextPage }">
	      		 <a href="?bid=${param.bid }&size=${param.size}&page=${pageInfo.nextPage}" 
	      		 class="next">
       ...
       <!-- 마지막 페이지 -->
       	<li>
       		<a href="?bid=${param.bid }&size=${param.size}&page=${pageInfo.pages}" class="last">
